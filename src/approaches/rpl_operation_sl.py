...
from all_protocols.all_protocols import rpl_operation
from deprecated.network import create_network_with_dio, create_network_with_spanning_tree, plot_dodag, plot_network
