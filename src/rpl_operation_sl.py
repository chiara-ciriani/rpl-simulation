...
def send_to_all_street_lights_using_rpl_operation(tx_range, num_nodes, num_street_lights):
...
if __name__ == "__main__":
    ...
    send_to_all_street_lights_using_rpl_operation(args.tx_range, args.num_nodes, args.num_street_lights)